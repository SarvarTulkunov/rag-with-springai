...
@RestController
public class ChatWithDBController {

    private final ChatModel chatModel;
    private final VectorStore vectorStore;

    private String prompt = """
            Your task is to answer the questions about the book "Atomic Habits" by James Clear.
    ...
    public ChatWithDBController(ChatModel chatModel, VectorStore vectorStore) {
        this.chatModel = chatModel;
        this.vectorStore = vectorStore;
    }

    @GetMapping("/")
    public String chat(@RequestParam(value = "question", defaultValue = "List all the Articles in the Indian Constitution")
                       String question) {
